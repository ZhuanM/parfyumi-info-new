import { FilterOptions } from "../modules/common/models/filterOptions/filterOptions";
import { Fragrance } from "../modules/common/models/fragrance/fragrance"

export class Fragrances {
    public static readonly fragrances: Array<Fragrance> = [
        {
            id: 1,
            name: "Man In Black",
            designer: "Bvlgari",
...
export class GenderOptions {
    public static readonly genderOptions: Array<FilterOptions> = [
        { id: 1, name: "Всички", value: "", checked: true },
        { id: 2, name: "Мъже", value: "male", checked: false },
        { id: 3, name: "Жени", value: "female", checked: false },
        { id: 4, name: "Унисекс", value: "unisex", checked: false }
    ];
}

export class DesignerOptions {
    public static readonly designerOptions: Array<FilterOptions> = [
        { id: 1, name: "Всички", value: "", checked: true },
        { id: 2, name: "Bvlgari", value: "Bvlgari", checked: false },
        { id: 3, name: "Calvin Klein", value: "Calvin Klein", checked: false },
        { id: 4, name: "Carolina Herrera", value: "Carolina Herrera", checked: false },
        { id: 5, name: "Chanel", value: "Chanel", checked: false },
        { id: 6, name: "Creed", value: "Creed", checked: false },
        { id: 7, name: "Christian Dior", value: "Christian Dior", checked: false },
        { id: 8, name: "Dolce & Gabbana", value: "Dolce & Gabbana", checked: false },
        { id: 9, name: "Giorgio Armani", value: "Giorgio Armani", checked: false },
    ];
}